...
data class SKU(private var map: LinkedTreeMap<String, Any?>) : Serializable, Parcelable {
    ...
    init {
        ...
        Volume = map["Volume"].toString().doubleValue
        Weight = map["Weight"].toString().doubleValue
        Amount = map["Amount"].toString().doubleValue.toInt()
        Links = map["Links"] as String?
        DomainFolderId = map["DomainFolderId"].toString().doubleValue.toInt()
        ...
        AmountForUser = map["AmountForUser"].toString().doubleValue.toInt()
