...
class GetOrdersListRequest(subscribe: String, private val skip: Int, private val take: Int) :
    AbsNetResultMessageRequest(subscribe) {
    companion object {
        const val NAME = "GetOrdersListRequest"
    }

    override fun getData(): Single<BaseResponse>? {
        return ApplicationSingleton.instance.getApi().getOrdersList(skip, take)
    }
