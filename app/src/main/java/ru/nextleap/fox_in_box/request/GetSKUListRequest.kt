...
class GetSKUListRequest(subscribe: String, private val skip: Int, private val take: Int) :
    AbsNetResultMessageRequest(subscribe) {
    companion object {
        const val NAME = "GetSKUListRequest"
    }

    override fun getData(): Single<BaseResponse>? {
        return ApplicationSingleton.instance.getApi().getSkuList(skip, take)
    }
