...
class SKURecyclerViewAdapter : AbsRecyclerViewAdapter<SKU, SKURecyclerViewAdapter.ViewHolder>() {
    init {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(position: Int, count: Int, item: SKU) {
            card.tag = item
            if (position == 0) {
